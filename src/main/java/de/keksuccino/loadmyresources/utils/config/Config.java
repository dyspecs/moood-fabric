...
public class Config {
   ...
   public void syncConfig() {
      ...
      Iterator var3 = this.getCategorys().iterator();
      ...
      while(true) {
         while(var3.hasNext()) {
            ...
            if (l.isEmpty()) {
               ...
               while(var6.hasNext()) {
                  ConfigEntry e = (ConfigEntry)var6.next();
   ...
   private File backupConfig() {
      ...
      String s;
      for(Iterator var5 = data.iterator(); var5.hasNext(); data2 = data2 + s) {
         s = (String)var5.next();
         if (!b) {
            b = true;
         } else {
   ...
   public List<ConfigEntry> getEntrysForCategory(String category) {
      ...
      while(var3.hasNext()) {
         Entry<String, ConfigEntry> m = (Entry)var3.next();
   ...
   public void registerValue(String uniqueName, Integer defaultValue, String category) throws InvalidValueException {
      this.registerRawValue(uniqueName, String.valueOf(defaultValue), category, ConfigEntry.EntryType.INTEGER, (String)null);
   }

   public void registerValue(String uniqueName, Double defaultValue, String category) throws InvalidValueException {
      this.registerRawValue(uniqueName, String.valueOf(defaultValue), category, ConfigEntry.EntryType.DOUBLE, (String)null);
   }

   public void registerValue(String uniqueName, Long defaultValue, String category) throws InvalidValueException {
      this.registerRawValue(uniqueName, String.valueOf(defaultValue), category, ConfigEntry.EntryType.LONG, (String)null);
   }

   public void registerValue(String uniqueName, Float defaultValue, String category) throws InvalidValueException {
      this.registerRawValue(uniqueName, String.valueOf(defaultValue), category, ConfigEntry.EntryType.FLOAT, (String)null);
   }

   public void registerValue(String uniqueName, Boolean defaultValue, String category) throws InvalidValueException {
      this.registerRawValue(uniqueName, String.valueOf(defaultValue), category, ConfigEntry.EntryType.BOOLEAN, (String)null);
   }

   public void registerValue(String uniqueName, String defaultValue, String category) throws InvalidValueException {
      this.registerRawValue(uniqueName, defaultValue, category, ConfigEntry.EntryType.STRING, (String)null);
   }
   ...
   public void clearUnusedValues() {
      ...
      while(var2.hasNext()) {
         Entry<String, ConfigEntry> m = (Entry)var2.next();
   ...
   public <T> T getOrDefault(String valueName, T defaultValue) {
      try {
         if (defaultValue instanceof Integer) {
            return this.getInteger(valueName);
         }

         if (defaultValue instanceof Boolean) {
            return this.getBoolean(valueName);
         }

         if (defaultValue instanceof String) {
            return this.getString(valueName);
         }

         if (defaultValue instanceof Long) {
            return this.getLong(valueName);
         }

         if (defaultValue instanceof Double) {
            return this.getDouble(valueName);
         }
